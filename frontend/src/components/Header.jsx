      ...
      <div className="container mx-auto h-full flex items-center px-8 justify-between">
        ...
        <div className='flex gap-4 items-center'>
          ...
          <div className='space-x-2'>
            ...
            {/* LogIn button */}
            <Link to={"/login"} className=' bg-slate-700/25 text-blue-500 hover:bg-slate-800/5 px-3 py-1 rounded-full'>LogIn</Link>
            {/* signUp button */}
            <Link to={"/signup"} className=' bg-slate-700/25 text-blue-500 px-3 py-1 rounded-full hover:bg-slate-800/5'>SignUp</Link>
          </div>
        </div>
      </div>
    </header>
